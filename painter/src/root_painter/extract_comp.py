...
class ExtractCompWidget(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        info_label.setText(
            "Segmentation directory, image and composites directorymust be specified."
        )
    ...
    def validate(self):
        if not self.seg_dir:
            self.info_label.setText(
                "Segmentation directory must be specified to extract composites."
            )
        ...
        if not self.im_dir:
            self.info_label.setText(
                "Image directory must be specified to extract composites."
            )
            self.submit_btn.setEnabled(False)
            return
        ...
        if not self.comp_dir:
            self.info_label.setText(
                "Composites directory must be specified to extract composites."
            )
            self.submit_btn.setEnabled(False)
            return
